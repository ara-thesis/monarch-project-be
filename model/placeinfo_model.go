...
type PlaceInfoModel struct {
	...
	Place_opentime  int     `json:"place_opentime" xml:"place_opentime" form:"place_opentime"`
	Place_closetime int     `json:"place_closetime" xml:"place_closetime" form:"place_closetime"`
}
